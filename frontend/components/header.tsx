          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-3">
              <div className="w-12 h-12 flex items-center justify-center flex-shrink-0">
                <img src="https://res.cloudinary.com/dpp7ylg7d/image/upload/v1780729759/WhatsApp_Image_2026-06-06_at_12.38.28_PM_uadj9c.jpg" alt="Kasturi Eye Clinic & Opticals" className="w-12 h-12 object-contain rounded-lg" />
              </div>
          ...
          {navLinks.map((link) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-[10px] font-medium leading-tight ${active ? "text-blue-600" : "text-gray-500"}`}>
                  {link.label}
                </span>
                {active && (
